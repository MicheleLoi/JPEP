...
word_count: "pending Word recount post-v1.12 (estimated ~8,500 words / ~20 pages; prior v1.11: ~9,020 words; prior v1.10: ~8,685 words; prior v1.7: 10,647 words / 25 pages — cumulative cuts: §4 collapse + §6.4 absorption removed ~1,100 net body words at v1.8; §5/§6 swap + §6 compression to feasibility sketch removed ~400 further at v1.9; §3.3 Reviewer-1 revision + §6 SP-N derivation + §7 loss-inhabiting addition net ~−460w at v1.10; v1.11 Earp integration net +333 w; v1.12 Archive testimonial-layer assembly + 14-cut compression pass net ~−535 w body)"
