...
venue_type: Topical Collection / Special Issue
topic: AI Tools in Ethics Research
branch: cfp-ai-ethics-inquiry
branch_policy: permanent — never merged to main
branched_from: III-v3-mhc-revision (commit 76435f2)
date_saved: 2026-03-02
---

# Call for Papers: AI Tools in Ethics Research
...
## Notes on Paper Adaptation

The JPEP paper is relevant to several questions above, particularly:
- The discovery/justification question (Section 6 explicitly rejects this framing as inadequate)
- What kinds of tasks AI can support in philosophical research
- Risks and goods lost (Section 2, Section 6)
- Methodological implications (Sections 5–7, Appendix)

The paper's current target (JPEP) is not an ethics-specific venue. This CFP targets ethics research specifically — adaptation may need to:
- Foreground the ethics-research relevance more explicitly
- Adjust the framing of the transparency apparatus toward ethics methods
- Assess fit with the "not focused on education" restriction
