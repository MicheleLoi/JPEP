...
caption_text = (
    ...
    "indicates artifact type (see legend). Four session clusters left-to-right:\n"
    ...
    "Code / Sonnet 4.6 after model switch); SUN4 — CFP double-contestation + redundancy pass\n"
    "(Apr 2026, Claude Code / Opus 4.6).\n"
    "  SUN4's right cluster (11 nodes) contains drafts for every section of the paper —\n"
    "CFP_5.4.3 Introduction, 5.4.5 §2, 5.4.4 §3, 5.4.7 §5, 5.4.8 §6, 5.4.9 §7, 5.4.10\n"
    "Conclusion — plus modlogs CFP_4.2.20 (Conclusion) and CFP_4.2.21 (double-contestation\n"
    "implementation). This large orbit reflects that SUN4 was a cross-paper session: the\n"
    "double-contestation argument was distributed across all sections simultaneously, and the\n"
    "redundancy pass cut 28% of words paper-wide. Only CFP_5.4.8 (§6) belongs to the Section\n"
    "6 chain; the rest show the scope of SUN4's reach.\n"
    "  The lower rail is the version chain: III_4.2.13 bridges SUN2→SUN3 (records 4.2.9 as\n"
    "source, outputs revised guidance III_4.4.5 and PDL III_5.2.1); SID-20260302-152952\n"
    "produced III_5.4.2 (Section 6 v3), the direct source of CFP_5.4.8; CFP_4.2.18 records the\n"
    "three-draft CFP session. CFP_4.7.20 (teal, bottom) synthesises all four phases → SP-3."
)
fig.text(
