---
project: JPEP
document_type: Type - Reference List
label: paper_bibliography_FINAL
title: "Complete Paper Bibliography — Submission Ready"
status: Active
build_source: true
...
*Submission-ready. Compiled from all CFP-era section draft reference lists.*
*For working notes, section-by-section usage, and process history, see `paper_bibliography.md`.*
