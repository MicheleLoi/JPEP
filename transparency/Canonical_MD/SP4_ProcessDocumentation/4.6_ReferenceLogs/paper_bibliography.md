...
## STATUS: Updated Through Section 7 (CFP branch)

This bibliography compiles all references used across completed sections of the paper. Additional references will be added as remaining sections are written.
...
### Section 3: Why Engage Transparently? — CFP adaptation (branch: cfp-ai-ethics-inquiry)
- Blackburn (1993)
- Enoch (2011)
- Gallie (1956)
- Gibbard (1990)
- Kierkegaard (1992/1846)
- Nietzsche (1966/1886)
- Plato, *Apology* 38a
...
### Structural Dilemma (Section III)
*No additional references - develops argument from first principles*

### Problem of Unfair Reviews (Section IV)
*No additional references - presents hypothesis about this paper's submission*

### Positive Motivations (Section V)
- Aristotle, *Metaphysics*
- Boden & Edmonds (2009) - via Wheeler
- Byrne (2012) - cited with pages: pp. 14-15, 92-93, 17-21
- Clark (2008) - via Wheeler
- Dewey (1925) - cited with pages: pp. 34-35
- Floridi (2025a, 2025b)
- Mill (1859) - Ch. III
- Plato, *Theaetetus*
- Quine (1969)
- Wheeler (2018) - cited extensively with Kindle locations: pp. 231-234, 239-240, 241-242

### Section VI: Mandatory Transparency in Practice (CFP)
- Gallie (1956) — essentially contested concept (from Section 3, referenced)
- Kierkegaard (1992/1846) — authenticity tradition
- Lloyd (2025) — epistemic responsibility (engagement)
- Nietzsche (1966/1886) — authenticity tradition
- Santoni de Sio & van den Hoven (2018) — MHC framework (tracing/tracking)
- Santoni de Sio et al. (2016) — constitutive/regulative distinction
...
### From Wheeler's Bibliography
The following sources are cited via Wheeler. Need to verify exact citations match Wheeler's reference list:

1. **Boden & Edmonds (2009)** - Is this the correct citation Wheeler uses?
2. **Clark (2008)** - Is this the correct citation Wheeler uses for "cognitive niche construction"?

**Action:** Check Wheeler (2018) reference list to confirm these citations.

### Wheeler Page Numbers
Current citations use Kindle section locations. User will convert to page numbers from Gaut & Kieran (2018) volume in final Word file.
...
### Daily Nous Sources
Limited use - teaching-focused, paper brackets teaching/learning issues:
- Jollimore (2025)
- Rini (2025)  
- Berg & Robbins (2024)
- Ontiveros & Clay (2021)

These establish debate framing in Introduction but are not central to argument.

### Floridi Citations
Two distinct works:
- **(2025a)** "Distant Writing" - concept of AI-mediated literary production
- **(2025b)** "AI as Agency without Intelligence" - Multiple Realisability of Agency thesis

Both used substantively in Section V.

### Wheeler and Secondary Sources
Wheeler (2018) analyzes Byrne's observations philosophically. When citing:
- **Byrne's observations** (CBGB, vinyl, cathedrals) → cite Byrne (2012) directly
- **Wheeler's analysis** (inside-and-outside logic, philosophical framework) → cite Wheeler (2018)
- **Boden & Edmonds, Clark** → cited via Wheeler with acknowledgment

### Classical Sources
Standard references by passage:
- Plato, *Theaetetus* 155d
- Aristotle, *Metaphysics* 982b12-13

No page numbers needed; cited by standard textual divisions.

---

## REFERENCES REMOVED FROM CFP ADAPTATION
...
## REFERENCES REMOVED FROM EARLIER VERSIONS

The following were in preliminary reference lists but cut as unnecessary:

- **Byrne references:** Initially considered for removal as "too far from philosophy" but reinstated and cited extensively
...
- (Author, Year, pp. X-Y) for specific passages
- Classical sources by standard reference (Theaetetus 155d)

**Footnotes:**
- Substantive clarifications
- Secondary citations (via Wheeler)
- Technical details that would interrupt flow

### Bibliography Format
Following standard philosophy journal format:
- Author. (Year). "Title." *Journal/Book*, Volume(Issue), pages. [DOI/URL where applicable]
- Classical sources by standard reference without year
...
### Final Copyedit
1. Standardize "and" → "&" in all inline author lists across section drafts
2. Ensure all section-end reference blocks use consistent format (sentence case, journal in italics, DOI where available)
3. Complete full author list for Abdulhai et al. (2026) — currently abbreviated in Section 7 draft
4. Verify Boden & Edmonds citation from Wheeler's reference list (v1 baseline only; not in CFP)
5. Verify Clark citation from Wheeler's reference list (v1 baseline only; not in CFP)
6. Convert Wheeler Kindle locations to page numbers in final Word file (v1 baseline only; not in CFP)

### Before Final Submission
7. Ensure all citations in text have corresponding bibliography entries
8. Ensure all bibliography entries are cited in text
9. Verify all URLs are current and functional
10. Check all DOIs resolve correctly
11. Confirm page numbers for all sources

---

## COMPILATION STATUS

**Complete through:** Section 7 (CFP branch)
**Remaining:** Abstract/Title (Phase 4); final bibliography compilation
**Last updated:** 2026-04-02
**New entries added (2026-03-03):** Blackburn (1993), Enoch (2011), Gallie (1956), Gibbard (1990), Lloyd (2025), Santoni de Sio et al. (2016), Santoni de Sio & van den Hoven (2018), Shafer-Landau (2003)
**New entries added (2026-04-01):** Kierkegaard (1992/1846), Nietzsche (1966/1886), Plato *Apology* 38a — added with Section 3 CFP v2 (double contestation / authenticity argument)
**New entries added (2026-04-02):** Abdulhai et al. (2026), Cheng et al. (2025), Zimmerman (2002) — Section 7 §7.2 + §7.4 additions (CFP_4.4.14 Step 2)
## Connections (auto)
