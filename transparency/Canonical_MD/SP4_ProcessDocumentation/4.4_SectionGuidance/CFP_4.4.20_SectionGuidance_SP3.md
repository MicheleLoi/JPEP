...
source_documents:
  - "CFP_5.2.4_pdl_SP1_SP2_SP3.md (PDL-004 through PDL-017)"
...
validated: ""
validation: ""
supersedes: "CFP_4.4.20_SectionGuidance_SP3.md v2 (2026-04-02, graph-led show-and-tell structure)"
---
...
Tools: Claude.ai web + ChatGPT. Session IDs not established. The Complete Prompt governed writing of Sections I–VI. Ontology co-development: the Type 2b category emerged from practice, not from pre-planning (evidence: `5.3.1` and `4.4.3` share `source_chat_id: 30a52e69`). The feedback loop: appendix written after the paper body, then fed back into Section 6 revision (evidence: `4.2.11`, `4.4.13`, `4.2.9` MOD-009). The self-philology story: Word/RTF to Canonical Markdown conversion, chat logs as primary ground truth for metadata reconstruction.

**Author role in Phase 1:** prompt author and content reviewer. The human wrote prompts, evaluated outputs, and directed revisions — but within a framework the human had designed (the Complete Prompt). Documentation was not a conscious activity; it was a byproduct of using the tools.
...
- The three phases with their characterization of the human author's role
...
*Section Guidance v3 — rewritten 2026-04-03 (SID-20260403-000000)*
*Previous version (v2) superseded: graph-led show-and-tell structure replaced by research-paper methodology*
