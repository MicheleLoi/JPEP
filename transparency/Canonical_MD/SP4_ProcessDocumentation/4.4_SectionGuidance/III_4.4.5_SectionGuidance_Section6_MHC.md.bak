...
inputs_for_drafting_ai:
  ...
  - "Paper/MDversion/Full paper2511.08639v1.md (for current Section 6 structure)"
---

# Section Guidance: Section 6 - Mandatory Transparency in Practice

## SIGNIFICANT REVISION - Stage III
...
## The Argumentative Structure for Section 6

### Opening (1-2 paragraphs)
Connect to Section 3: We cannot settle whether AI changes philosophy, but we can ensure that philosophical production under AI assistance remains *attributable* to human intellectual agency. This is the function of transparency.

### The MHC Framework (3-4 paragraphs)
- Introduce tracking and tracing conditions
- Explain why tracing is the distinctive challenge for scholarship
- Use the weapons parallel (soldier pressing button without understanding)
- Apply to scholarship (scholar prompting without being able to defend)
- Include the key quote from Santoni de Sio & van den Hoven

### Operationalizing Tracing (3-4 paragraphs)
- Reproduction test as tracing verification
- How SP-1 through SP-5 serve tracing (table)
- SP-4 (process documentation) as the core

### Engagement with Lloyd (2-3 paragraphs)
- Acknowledge Lloyd's contribution
- Adopt Standards 1-2 (modified), reject Standard 4
- Explain why: process over provenance

### The Three Nested Concerns (1-2 paragraphs)
- Epistemic integrity → Tracing → Tracking what philosophy becomes
- Everything is instrumental to the meta-philosophical goal

### Closing (1 paragraph)
Forward reference to Section 7 (reproduction test) and the practical implementation.
