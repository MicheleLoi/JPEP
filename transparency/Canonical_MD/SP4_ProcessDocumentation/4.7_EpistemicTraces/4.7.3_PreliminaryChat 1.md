...
input_artifacts: SP5.1, 4.7.1, 4.7.2, 4.3.1, 4.3.2, 4.3.3, 4.3.4, 4.3.5, 4.5.1, 4.5.2, 4.5.3, 4.5.4, 4.5.5, 4.5.6, 4.2.1, 4.2.2, 4.2.3, 4.2.4, 4.2.6, 4.2.7, 4.1
notes: Pattern Summaries listed are all 5 that exist. No pattern summary was created for Section I (Introduction) or Section VI (Dilemma), despite the original description reading 'Sections I-VI Pattern Summaries'.
