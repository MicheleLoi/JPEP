...
- **Before submit (EthIT-specific, surfaced 2026-06-14):** add **4–6 keywords**; enter **Declarations** (Competing Interests, Funding, Author Contributions) + a **Data-Availability** statement via the Snapp interface (NOT in the anon manuscript, under double-blind); prepare a **separate non-anon title page**; do a final **APA-7** reference restyle; **disambiguate** Hosseini 2023 / Earp 2026 (a/b) in-text + bibliography.
