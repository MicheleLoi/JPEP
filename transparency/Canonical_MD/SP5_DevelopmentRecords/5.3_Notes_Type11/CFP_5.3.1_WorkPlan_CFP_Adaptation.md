...
## RESUME HERE (last updated 2026-06-23, after the pre-submission reading-pass → v1.26 + the v1.26 submission docx rebuilt/verified — `Full_paper_canonical.md` at v1.26 on `main`)
...
- Complete the EthIT submission form incl. the AI-use declaration field; upload the **anon `.docx`** — ⚠️ EthIT requires an **editable manuscript, NOT a PDF**: `Full_paper_submission_anon.docx` is **BUILT at v1.26** (2026-06-23; re-derived + pandoc; identifier-free, Dennett-free, 0 inline bold, native footnotes — verified, do a final eyeball before upload) + **cover letter** (`target-venue/cover_letter_ethit.md`); upload **arXiv v4** to update 2511.08639.
