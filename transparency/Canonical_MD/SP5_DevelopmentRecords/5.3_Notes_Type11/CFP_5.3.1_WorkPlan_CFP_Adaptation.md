...
## RESUME HERE (last updated 2026-06-14, after the v1.16→v1.24 EthIT-prep cycle — paper renamed `Full_paper_canonical.md`, at v1.24 on `main`)
...
- Complete the EthIT submission form incl. the AI-use declaration field; upload the **anon `.docx`** — ⚠️ EthIT requires an **editable manuscript, NOT a PDF**: `Full_paper_submission_anon.docx` must still be generated (re-derive the anon `.md` from the v1.20 canonical, then pandoc → docx) + **cover letter** (`target-venue/cover_letter_ethit.md`); upload **arXiv v4** to update 2511.08639.
