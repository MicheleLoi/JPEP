...
## RESUME HERE (last updated 2026-06-23, after the v1.27 Archive-note → Supplementary-Material cut — `Full_paper_canonical.md` at v1.27 on `main`; submission docx + anonymized supplement rebuilt/verified)
...
- Complete the EthIT submission form incl. the AI-use declaration field; upload the **anon `.docx`** — ⚠️ EthIT requires an **editable manuscript, NOT a PDF**: `Full_paper_submission_anon.docx` is **BUILT at v1.27** (2026-06-23; re-derived + pandoc; **Archive note removed → supplement**, identifier-free, native footnotes — verified, do a final eyeball before upload) + **cover letter** (`target-venue/cover_letter_ethit.md`); upload **arXiv v4** to update 2511.08639.
