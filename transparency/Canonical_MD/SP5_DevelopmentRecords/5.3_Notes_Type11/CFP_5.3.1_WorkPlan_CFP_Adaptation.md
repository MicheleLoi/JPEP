...
## RESUME HERE (last updated 2026-06-22, after the June-19 parallel-laptop edit recovery → v1.25 + the two-repo sync split — `Full_paper_canonical.md` at v1.25 on `main`)
...
- Complete the EthIT submission form incl. the AI-use declaration field; upload the **anon `.docx`** — ⚠️ EthIT requires an **editable manuscript, NOT a PDF**: `Full_paper_submission_anon.docx` is **BUILT at v1.25** (2026-06-22; re-derived from canonical + pandoc; Dennett-free, identifier-free — do a final eyeball before upload) + **cover letter** (`target-venue/cover_letter_ethit.md`); upload **arXiv v4** to update 2511.08639.
