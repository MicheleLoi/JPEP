...
These mechanisms combine to allow systematic minimization of reported AI involvement precisely when work appears professionally significant—producing not deliberate fraud but predictable response to incentive structures that penalize transparency while demanding formal disclosure. The result is a *transparency paradox*: where transparency matters most, we get least, because the work most likely to shape scholarly discourse faces the strongest pressure to underreport.
