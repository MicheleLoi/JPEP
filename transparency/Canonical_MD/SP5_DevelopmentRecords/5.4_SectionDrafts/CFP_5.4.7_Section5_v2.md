...
transformation: "v2 → v2.1: Redundancy pass 1. Compressed Section 2 re-summary to one sentence; trimmed §5.1–§5.3 elaborations; cut §5.4 'mutually reinforcing' paragraph; removed 'not naivety' LLM-tell formula. Net −~200 words."
word_count: ~785
---
...
An adequate framework must ensure that comprehensive documentation is both the natural output of genuine AI-assisted work and credibly different from minimal disclosure. As Mercier (2020) argues in *Not Born Yesterday*, signals expensive to produce prove harder to fake and thus more credible. Comprehensive documentation is such a signal. AI tools can generate plausible-seeming documentation, but documentation specific enough to serve genuine epistemic functions is roughly as expensive to fabricate as to produce authentically.
