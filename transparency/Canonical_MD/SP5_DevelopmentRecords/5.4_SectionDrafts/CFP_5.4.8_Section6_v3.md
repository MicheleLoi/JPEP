...
The contestation that makes neutral adjudication impossible generates two distinct routes to that requirement. For expressivists, quality criteria are constitutively process-dependent: non-cognitivist coherence is coherence of a *person's* evaluative attitudes, and an AI can produce text that simulates this without any genuine evaluative engagement taking place. The output underdetermines whether the relevant process occurred. Process documentation is therefore required if the work is to be assessable on expressivist terms. A second route runs through the authenticity tradition established in Section 3: if what ethical authoring requires of the author is genuinely contested — if the Socratic, Kierkegaardian, and Nietzschean insistence that the *how* of inquiry is constitutive cannot be ruled out — then documentation is equally required to enable assessment on those terms. The two routes are independent; documentation satisfies both.

These requirements also serve the authenticity of philosophical work — and this is the real point. The concern is not primarily about detecting authors who simulate engagement they never had. It is about enabling authors whose authentic mode of engagement is technological exploration — who genuinely think through AI collaboration, who find in iterative dialogue a medium for philosophical inquiry — to present that identity honestly. For such an author, documentation is not a constraint but a condition: it is what allows a genuinely new form of philosophical practice to be legible as such, rather than being rendered invisible by opacity. The authentic technological explorer and the traditional humanist scholar both require documentation, but for the same underlying reason: without it, their respective modes of engagement cannot be assessed on their own terms.

For the expressivist evaluator, opacity forecloses assessment entirely — you cannot determine whether genuine evaluative engagement occurred without process information. For evaluators working within the authenticity tradition, opacity prevents the very question they need to ask: was the *how* of the author's engagement constitutive of genuine philosophical inquiry? In either case, attribution is epistemically necessary. This is what the tracing condition captures: it operationalizes the condition under which contributions to ethics research remain assessable by evaluators whose criteria — expressivist or authenticity-based — are constitutively process-dependent.
...
Disclosure requirements must balance three functions: *verification* (establishing authorship and accountability), *methodological learning* (enabling community understanding of effective practices), and *assessability by process-dependent evaluators* — enabling those working within traditions whose evaluative criteria are constitutively process-dependent, namely the expressivist and authenticity-based positions established in Section 3, to conduct their assessment. This third function follows directly from the essential contestedness of ethical inquiry: because we cannot foreclose which evaluative criteria are correct, the framework must serve those for whom process information is not supplementary but constitutive. The framework requires accessibility—scholars without technical training must find documentation feasible.
...
At the innermost level, **epistemic integrity** ensures that claims produced under AI assistance are trustworthy—confabulation controlled, sources verified, arguments valid. At the middle level, **meaningful human control** through the tracing condition ensures that intellectual contributions are attributable to human understanding and direction. This requirement holds on both grounds established in Section 6.1: expressivist evaluators require tracing to determine whether genuine evaluative engagement occurred; evaluators working within the authenticity tradition require tracing to assess whether the author's mode of engagement was constitutive of genuine philosophical inquiry. At the outermost level, **tracking what ethics research becomes** requires that tracing be verifiable across the scholarly community, enabling the informed meta-level discussion that Section 3 identifies as the achievable goal.
