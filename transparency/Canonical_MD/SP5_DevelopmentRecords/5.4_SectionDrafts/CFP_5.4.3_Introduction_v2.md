...
source_file: "CFP_5.4.3_Introduction_v2.md"
derived_from: "CFP_5.4.3_Introduction_v2.md"
cfp_target: "AI Tools in Ethics Research (topical collection)"
session_id: SID-20260401-173934
transformation: "v2 → v2.1: Redundancy pass 1. Removed double-contestation preview development (kept in Section 3); removed duplicate 'mandates don't specify' paragraph; compressed self-exemplification; tightened roadmap; removed verbatim repetitions appearing in Section 3. Net −~530 words."
word_count: ~740
---
# 1. Introduction
...
Section 2 examines structural barriers to disclosure. Section 3 develops the essentially-contested argument. Section 5 addresses conditions for adequate transparency. Section 6 specifies the framework. Section 7 addresses community assessment of documentation adequacy. Section 8 reflects on the paper's own practice.
